...
def generate_launch_description():
    ...
    print(pkg_share)
    keyboard_control_node_path = os.path.join(pkg_share, 'para_control', 'joy_to_twist_node_copy.py')
    motor_control_node_path = os.path.join(pkg_share, 'para_control', 'motor_controller_node_copy.py')
